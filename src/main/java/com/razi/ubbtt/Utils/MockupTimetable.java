...
public class MockupTimetable {
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob1() {
        ...
        operationsDurationMap.put(new Tuple3<>(1, 1,1), new AdditionalInfo("curs", "8-10", "6/II", "IE2"));
        operationsDurationMap.put(new Tuple3<>(1, 1,2), new AdditionalInfo("seminar", "12-14", "C310", "931"));
        operationsDurationMap.put(new Tuple3<>(1, 1,3), new AdditionalInfo("laborator", "8-10", "L301", "933"));
        ...
        operationsDurationMap.put(new Tuple3<>(2, 1, 3), new AdditionalInfo("laborator", "8-10", "L308", "936"));
        ...
        operationsDurationMap.put(new Tuple3<>(3, 1, 3), new AdditionalInfo("laborator", "14-16", "L306", "937"));
        ...
        operationsDurationMap.put(new Tuple3<>(4, 1, 3), new AdditionalInfo("laborator", "10-12", "L336", "935"));
        ...
        operationsDurationMap.put(new Tuple3<>(5, 1, 3), new AdditionalInfo("laborator", "8-10", "2/I", "933"));
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob2() {
        ...
        operationsDurationMap.put(new Tuple3<>(1, 2,1), new AdditionalInfo("curs", "10-12", "C510", "IE2"));
        operationsDurationMap.put(new Tuple3<>(1, 2,2), new AdditionalInfo("seminar", "10-12", "2/I", "932"));
        operationsDurationMap.put(new Tuple3<>(1, 2,3), new AdditionalInfo("laborator", "10-12", "L301", "935"));

        operationsDurationMap.put(new Tuple3<>(2, 2,1), new AdditionalInfo("curs", "8-10", "C510", "IE2"));
        operationsDurationMap.put(new Tuple3<>(2, 2,2), new AdditionalInfo("seminar", "14-16", "C410", "936"));
        operationsDurationMap.put(new Tuple3<>(2, 2,3), new AdditionalInfo("laborator", "12-14", "L302", "932"));
        ...
        operationsDurationMap.put(new Tuple3<>(4, 2,2), new AdditionalInfo("seminar", "14-16", "6/II", "936"));
        ...
        operationsDurationMap.put(new Tuple3<>(5, 2,2), new AdditionalInfo("seminar", "8-10", "6/II", "933"));
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob3() {
        ...
        operationsDurationMap.put(new Tuple3<>(1, 3,2), new AdditionalInfo("seminar", "8-10", "C310", "932"));
        operationsDurationMap.put(new Tuple3<>(1, 3,3), new AdditionalInfo("laborator", "10-12", "L300", "934"));

        operationsDurationMap.put(new Tuple3<>(2, 3,1), new AdditionalInfo("curs", "14-16", "Beta", "IE2"));
        operationsDurationMap.put(new Tuple3<>(2, 3,2), new AdditionalInfo("seminar", "12-14", "6/II", "936"));
        operationsDurationMap.put(new Tuple3<>(2, 3,3), new AdditionalInfo("laborator", "14-16", "L301", "936"));

        operationsDurationMap.put(new Tuple3<>(3, 3,1), new AdditionalInfo("curs", "8-10", "Beta", "IE2"));
        operationsDurationMap.put(new Tuple3<>(3, 3,2), new AdditionalInfo("seminar", "16-18", "2/I", "932"));
        ...
        operationsDurationMap.put(new Tuple3<>(4, 3,2), new AdditionalInfo("seminar", "16-18", "C312", "934"));
        operationsDurationMap.put(new Tuple3<>(4, 3,3), new AdditionalInfo("laborator", "10-12", "L303", "935"));

        operationsDurationMap.put(new Tuple3<>(5, 3,1), new AdditionalInfo("curs", "12-14", "Beta", "IE2"));
        operationsDurationMap.put(new Tuple3<>(5, 3,2), new AdditionalInfo("seminar", "12-14", "C512", "937"));
        operationsDurationMap.put(new Tuple3<>(5, 3,3), new AdditionalInfo("laborator", "8-10", "L306", "937"));
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob4() {
        ...
        operationsDurationMap.put(new Tuple3<>(4, 4,1), new AdditionalInfo("curs", "8-10", "6/II", "IE2"));
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob5() {
        ...
        operationsDurationMap.put(new Tuple3<>(2, 5,2), new AdditionalInfo("seminar", "16-18", "C512", "936"));
        ...
        operationsDurationMap.put(new Tuple3<>(4, 5,1), new AdditionalInfo("curs", "10-12", "C310", "IE2"));
        operationsDurationMap.put(new Tuple3<>(4, 5,2), new AdditionalInfo("seminar", "8-10", "C512", "934"));
        operationsDurationMap.put(new Tuple3<>(4, 5,3), new AdditionalInfo("laborator", "12-14", "L308", "933"));

        operationsDurationMap.put(new Tuple3<>(5, 5,1), new AdditionalInfo("curs", "8-10", "C310", "IE2"));
        operationsDurationMap.put(new Tuple3<>(5, 5,2), new AdditionalInfo("seminar", "14-16", "6/II", "934"));
        operationsDurationMap.put(new Tuple3<>(5, 5,3), new AdditionalInfo("laborator", "18-20", "L303", "937"));
    ...
    private Map<Tuple3<Integer, Integer, Integer>, AdditionalInfo> getOperationsDurationMapForJob6() {
        ...
        operationsDurationMap.put(new Tuple3<>(1, 6,2), new AdditionalInfo("seminar", "14-16", "Gamma", "932"));
        operationsDurationMap.put(new Tuple3<>(1, 6,3), new AdditionalInfo("laborator", "16-18", "2/I", "934"));

        operationsDurationMap.put(new Tuple3<>(2, 6,1), new AdditionalInfo("curs", "10-12", "2/I", "IE2"));
        operationsDurationMap.put(new Tuple3<>(2, 6,2), new AdditionalInfo("seminar", "8-10", "Pi", "937"));
        operationsDurationMap.put(new Tuple3<>(2, 6,3), new AdditionalInfo("laborator", "10-12", "2/I", "935"));

        operationsDurationMap.put(new Tuple3<>(3, 6,1), new AdditionalInfo("curs", "12-14", "2/I", "IE2"));
        operationsDurationMap.put(new Tuple3<>(3, 6,2), new AdditionalInfo("seminar", "18-20", "Gamma", "935"));
        ...
        operationsDurationMap.put(new Tuple3<>(4, 6,2), new AdditionalInfo("seminar", "14-16", "Pi", "932"));
        ...
        operationsDurationMap.put(new Tuple3<>(5, 6,2), new AdditionalInfo("seminar", "12-14", "Gamma", "936"));
    ...
    private void generateJobs(List<ClassJob> jobs) {
        for (int j = 0; j < this.jobCount; ++j) {
            ClassJob job = new ClassJob(j + 1, 3, getOperationsDurationMapForJob(j + 1));
            jobs.add(job);
        }
    }
